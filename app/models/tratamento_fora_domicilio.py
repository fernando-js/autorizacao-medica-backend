"""Modelo de Tratamento Fora de Domicílio"""
...
class TratamentoForaDomicilio(Base):
    """Modelo de Tratamento Fora de Domicílio"""
    __tablename__ = "tratamentos_fora_domicilio"
    ...
    # Relacionamentos
    usuario = relationship("Usuario", back_populates="tratamentos")
